...
- [ ] New public API: includes documentation comments
- [ ] Breaking change: major version bump discussed in linked issue
- [ ] All public types conform to `Sendable`
- [ ] `send()` and `close()` remain safe for concurrent use (actor-isolated)
- [ ] All spawned Tasks have explicit cancellation paths
